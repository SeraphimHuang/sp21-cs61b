...
public class Main {
  ...
  /**
   * Runs one of three commands: story [text] -- Appends "text" + a newline to a story file in the
   * .capers directory. Additionally, prints out the current story.
   * <p>
   * dog [name] [breed] [age] -- Persistently creates a dog with the specified parameters; should
   ...
   * <p>
   * All persistent data should be stored in a ".capers" directory in the current working
   * directory.
   * <p>
   ...
   * <p>
   * .capers/ -- top level folder for all persistent data in your lab12 folder - dogs/ -- folder
