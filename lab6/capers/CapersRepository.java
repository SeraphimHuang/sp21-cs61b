...
public class CapersRepository {
    ...
    public static void setupPersistence() throws IOException {
        // TODO
        // need to first create CAPERS_FOLDER and then nested folders inside it
    ...
    public static void writeStory(String text) {
        // TODO
        File story = Utils.join(CAPERS_FOLDER, "story");
        String curStory = Utils.readContentsAsString(story) + text + "\n";
        Utils.writeContents(story, curStory);
        System.out.println(curStory);
    }
